        ...
        <div className='mx-36 flex flex-col my-32'>
            ...
            <div className="grid grid-cols-4 grid-rows-2 ">
                {products.map((product, index) => (
                    <div onClick={()=>{navigate('/product',{state:{product}})}} className="flex flex-col gap-5 relative mt-16" key={index} onMouseOver={() => { handleMouseEnter(index) }} onMouseLeave={() => { handleMouseLeave(index) }}>
